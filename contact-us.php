...
<style type="text/css">
  .image{
    background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url("assets/images/carInterior.jpg");
    min-height: 75vh;
...
{ ?>
          <ul>
            <li>
              ...
              <div class="contact_info_m">Bejaia, Algeria</div>
            </li>
            <li>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="mailto:contact@exampleurl.com">+213 790914986</a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
