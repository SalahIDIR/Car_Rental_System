...
<section id="listing_img_slider">
  <div><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image"  style="width: auto"></div>
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p style="color: #333"><span style="font-size:25px"><i class="fa fa-usd" aria-hidden="true"></i>
